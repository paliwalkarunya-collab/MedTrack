...
*Density: 8/10 ΓÇö Dense / Dashboard*
...
**Scroll Reveal** (Subtle) ΓÇö Trigger: scroll (viewport enter) | Duration: 300-400ms | Easing: `power1.out`
...
- Γ£à Keep the y offset small (8-16px) so it reads as a fade, not a slide
- Γ¥î Don't reveal below-the-fold content needed for SEO/crawlers as invisible-by-default without a no-JS fallback
- ΓÜí toggleActions 'play none none reverse' avoids re-triggering on every scroll direction change

---

## Anti-Patterns (Do NOT Use)

- Γ¥î Confusing layout
- Γ¥î Privacy concerns
- Γ¥î AI purple/pink gradients

### Additional Forbidden Patterns

- Γ¥î **Emojis as icons** ΓÇö Use SVG icons (Heroicons, Lucide, Simple Icons)
- Γ¥î **Missing cursor:pointer** ΓÇö All clickable elements must have cursor:pointer
- Γ¥î **Layout-shifting hovers** ΓÇö Avoid scale transforms that shift layout
- Γ¥î **Low contrast text** ΓÇö Maintain 4.5:1 minimum contrast ratio
- Γ¥î **Instant state changes** ΓÇö Always use transitions (150-300ms)
- Γ¥î **Invisible focus states** ΓÇö Focus states must be visible for a11y
